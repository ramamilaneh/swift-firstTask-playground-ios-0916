...
// I can't do it because myPuppyName is a constant and we can't change the value of it, if we want to change the value it should be defined as a variable not a constant
